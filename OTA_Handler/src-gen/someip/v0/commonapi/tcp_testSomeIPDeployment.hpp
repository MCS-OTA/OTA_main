...
#ifndef V0_COMMONAPI_tcp_test_SOMEIP_DEPLOYMENT_HPP_
#define V0_COMMONAPI_tcp_test_SOMEIP_DEPLOYMENT_HPP_
...
#endif // V0_COMMONAPI_tcp_test_SOMEIP_DEPLOYMENT_HPP_
