 ...
 */
#ifndef V0_COMMONAPI_OTA_INTER_SOMEIP_PROXY_HPP_
#define V0_COMMONAPI_OTA_INTER_SOMEIP_PROXY_HPP_
...
class OTA_interSomeIPProxy
    : virtual public OTA_interProxyBase,
      virtual public CommonAPI::SomeIP::Proxy {
public:
    OTA_interSomeIPProxy(
        const CommonAPI::SomeIP::Address &_address,
        const std::shared_ptr<CommonAPI::SomeIP::ProxyConnection> &_connection);

    virtual ~OTA_interSomeIPProxy();
...
#endif // V0_COMMONAPI_OTA_inter_SOMEIP_PROXY_HPP_
